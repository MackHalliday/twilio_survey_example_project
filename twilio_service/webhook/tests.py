...
from twilio_service.constant import (SURVEY__COMPLETE, SURVEY__CONFIRM_START,
...
class TwilioWebhookTestCase(TestCase):
    ...
    def test_user_can_opt_in(self):
        ...
        self.assertIn(SURVEY__CONFIRM_START, str(response.content))
    ...
    def test_user_can_opt_out(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(SURVEY__OPT_OUT_MESSAGE, str(response.content))
